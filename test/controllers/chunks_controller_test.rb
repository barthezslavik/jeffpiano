...
class ChunksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chunk" do
    assert_difference('Chunk.count') do
      post chunks_url, params: { chunk: { record_id: @chunk.record_id, source: @chunk.source, start_at: @chunk.start_at } }
    end
  ...
  test "should update chunk" do
    patch chunk_url(@chunk), params: { chunk: { record_id: @chunk.record_id, source: @chunk.source, start_at: @chunk.start_at } }
